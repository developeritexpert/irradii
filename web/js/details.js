...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
    $('.tab-pane.market-info').each(function(){
        $(this).removeClass('market-info');
    });
//    localStorage.clear();
    ...
    $('.todo .checkbox > input[type=\"checkbox\"]').click(function() {
        ...
        if ($(this).prop('checked')) {
            ...
            _this.slideUp(500, function() {
                _this.clone().prependTo('#sortable3').effect('highlight', {}, 800);
                _this.remove();
                countTasks();
            });
        } else {
    ...
    function countTasks() {
        ...
        $('.todo-group-title').each(function() {
            _this = $(this);
            _this.find('.num-of-tasks').text(_this.next().find('li').size());
        });
...
//    var plot = $.plot($('#updating-chart'), [getRandomData()], options);
    ...
    var options = {
        ...
        tooltip : true,
        tooltipOpts : {
            //content : 'Value <b>_x</b> Value <span>_y</span>',
            defaultTheme : false
        },
        xaxis : {
            ticks : [[1, "JAN '13"], [2, "FEB"], [3, "MAR"], [4, "APR"], [5, "MAY"], [6, "JUN"], [7, "JUL"], [8, "AUG"], [9, "SEP"], [10, "OCT"], [11, "NOV"], [12, "DEC"], [13, "JAN '14"]]
        },
        yaxes : {
