...
//console.log('nav ul');
	...
	$(document).mouseup(function(e) {
//            console.log($.shortcut_dropdown);
		if( typeof($.shortcut_dropdown) != 'undefined' && !$.shortcut_dropdown.is(e.target) && $.shortcut_dropdown.has(e.target).length === 0) {
			shortcut_buttons_hide();
		}
	});
