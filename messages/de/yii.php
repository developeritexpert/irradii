...
return array (
  ...
  'CProfileLogRoute.report "{report}" is invalid. Valid values include "summary" and "callstack".' => 'CProfileLogRoute.report "{report}" ist ungültig. Gültige Werte enthalten "summary" and "callstack".',
  ...
  'CUrlManager.UrlFormat must be either "path" or "get".' => 'CUrlManager.UrlFormat muss entweder "path" or "get" sein.',
  ...
  '{class}::$cost must be between 4 and 31.' => '{class}::$cost muss eine Zahl zwischen 4 and 31 sein.',
