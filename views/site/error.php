...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-sm-12">
				<div class="text-center error-box" style="padding-top: 50px;">
					<h1 class="error-text-2 bounceInDown animated" style="position: relative;"> 
                        Error 404 
                        <span class="particle particle--c"></span>
                        <span class="particle particle--a"></span>
                        <span class="particle particle--b"></span>
                    </h1>
					<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> <?= Html::encode($message) ?></strong></h2>
					<br />
					<p class="lead">
						The page you requested could not be found, either contact your webmaster or try again. Use your browsers <b>Back</b> button to navigate to the page you have previously come from
					</p>
					<p class="font-md" style="margin-top: 20px;">
						<b>... That didn't work for you? Try a new search in the header above.</b>
					</p>
				</div>
			</div>
		</div>
