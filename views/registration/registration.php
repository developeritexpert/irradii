            ...
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
                <div class="row">
                    <div class="hero">
                        ...
                        <!-- ✅ ADDED LOGO (same as Yii1) -->
                        <img src="<?= \app\components\CPathCDN::baseurl('img') ?>/img/demo/color_logo.png"
                        ...
                        <div class="pull-left login-desc-box-ll col-xs-12 col-sm-12 col-md-6 col-lg-5">
                            ...
                            <div class="login-app-icons">
                                <a href="<?= \yii\helpers\Url::to(['/property/search']) ?>" class="btn btn-danger btn-sm">Search Now</a>
                                <a href="<?= \yii\helpers\Url::to(['/blog/index']) ?>" class="btn btn-danger btn-sm">Learn more</a>
                            </div>
                        </div>

                        <!-- ✅ ADDED RIGHT IMAGE (same as Yii1) -->
                        <div class="pull-right login-desc-box-ll col-xs-12 col-sm-12 col-md-6 col-lg-7" style="overflow: hidden;">
                            <img src="<?= \app\components\CPathCDN::baseurl('img') ?>/img/demo/map_results.png"
                                class="pull-right map_results_main_page"
                                alt="">
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll terms-body">
                ...
                <br><br>
                <p><strong>By registering, you confirm that you have read and agree to these Terms and Conditions.</strong></p>
            </div>
